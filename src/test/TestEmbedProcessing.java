...
public class TestEmbedProcessing extends PApplet {

    static TestEmbedProcessing pt;
    static TestEmbedProcessingFrame frame_ref;
...
//        frame.setResizable(true);
        ...
        while (!movie.available()) {
            try {
                ...
                Logger.getLogger(TestEmbedProcessing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
...
//        println(e);
    ...
    public static TestEmbedProcessing load(TestEmbedProcessingFrame ref, String path) {
        frame_ref = ref;
        ref_frame_panel_width = frame_ref.getPanel().getWidth();
        ref_frame_panel_height = frame_ref.getPanel().getHeight();
        pt = new TestEmbedProcessing();
