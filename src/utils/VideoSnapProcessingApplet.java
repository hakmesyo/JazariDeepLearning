...
public class VideoSnapProcessingApplet extends PApplet {

    static VideoSnapProcessingApplet pt;
...
//        frame.setResizable(true);
        ...
        while (!movie.available()) {
            try {
                ...
                Logger.getLogger(VideoSnapProcessingApplet.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
...
//        println(e);
    ...
    public static VideoSnapProcessingApplet load(FrameVideoSnap ref, String path) {
        frame_ref = ref;
        ref_frame_panel_width = frame_ref.getPanel().getWidth();
        ref_frame_panel_height = frame_ref.getPanel().getHeight();
        pt = new VideoSnapProcessingApplet();
